...
public class CNAVICELL
{
    ...
    public void ToNavicellDataFromTri(int iSeqCell_, CTRI Tri_)
    {
        ...
        ToNavicellData();
    } // protected void ToNavicellDataFromTri(Vector3[] arv3TriPT, Vector3 v3NormalCell)

    //@ Calculate distance of each Cell's Edge from Cell's Center.
    protected void ToNavicellData()
    {
